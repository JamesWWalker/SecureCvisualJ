...
public class TestProcessState {
  ...
  public static String runTest() {
    ...
    ProcessState delta4R = new ProcessState(6, "asm4", delta4regs, delta4Rvars, delta4stack);
    ...
    ProcessState delta3R = new ProcessState(9, "asm3", delta3Rregs, delta3Rvars, delta3stack);

    TreeMap<String, VariableDelta> delta2Rvars = new TreeMap<>();
    TreeMap<String, String> delta2Rregs = new TreeMap<>();
    delta2Rregs.put("jcx", "12");
    ProcessState delta2R = new ProcessState(5, "asm2", delta2Rregs, delta2Rvars, delta2stack);

    TreeMap<String, VariableDelta> delta1Rvars = new TreeMap<>();
    ProcessState delta1R = new ProcessState(1, "asm1", delta1regs, delta1Rvars, delta1stack);
